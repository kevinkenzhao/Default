...
iptables -A FORWARD -p udp -m udp -s 10.13.1.10 --sport 53 -i eth0 -d 10.20.111.2 --dport 1024:65635 -j ACCEPT #return traffic to internal machine; state module not required as DNS request for PTR record is made over stateless UDP
iptables -A FORWARD -p udp -m udp -s 10.20.111.2 --sport 1024:65635 -i eth1 -d 10.13.1.10 --dport 53 -j ACCEPT
