...
iptables -A FORWARD -p tcp -s 10.10.111.0/24 --sport 1024:65635 -i eth0 -d 10.20.111.2 --dport 25 -m state --state NEW,ESTABLISHED,RELATED -j ACCEPT


#3) [20 pts] The internal machine should be able to perform a nslookup of fakebook.vlab.local
iptables -A FORWARD -p udp -m udp -s 10.10.111.1 --sport 53 -i eth0 -d 10.20.111.2 --dport 1024:65635 -j ACCEPT #return traffic to internal machine from name server at 10.10.111.1; state module not required as DNS request for PTR record is made over stateless UDP
iptables -A FORWARD -p udp -m udp -s 10.20.111.2 --sport 1024:65635 -i eth1 -d 10.10.111.1 --dport 53 -j ACCEPT
